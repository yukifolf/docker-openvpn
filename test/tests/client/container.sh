...
EASYRSA_BATCH=1 easyrsa build-client-full test1 nopass
...
# nopass is insecure
EASYRSA_BATCH=1 EASYRSA_REQ_CN="Test CA" ovpn_initpki nopass
EASYRSA_BATCH=1 easyrsa build-client-full client-fallback nopass
...
# nopass is insecure
EASYRSA_BATCH=1 EASYRSA_REQ_CN="Test CA" ovpn_initpki nopass
EASYRSA_BATCH=1 easyrsa build-client-full non-defroute nopass
